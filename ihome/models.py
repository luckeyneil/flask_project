...
class User(BaseModel, db.Model):
    ...
    def to_dict(self):
        ...
        user_dict = {
            ...
            "name": self.name,
            "mobile": self.mobile,
            "avatar": constants.QINIU_URL_PATH + self.avatar_url if self.avatar_url else "",
...
class House(BaseModel, db.Model):
    ...
    def to_full_dict(self):
        ...
        for image in self.images:
            img_urls.append(constants.QINIU_URL_PATH + image.url)
...
class Order(BaseModel, db.Model):
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            "img_url": constants.QINIU_URL_PATH + self.house.index_image_url if self.house.index_image_url else "",
